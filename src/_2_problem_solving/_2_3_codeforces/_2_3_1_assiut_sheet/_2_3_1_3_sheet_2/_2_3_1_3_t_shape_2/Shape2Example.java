package _2_problem_solving._2_3_codeforces._2_3_1_assiut_sheet._2_3_1_3_sheet_2._2_3_1_3_t_shape_2;
...
public class Shape2Example {
    ...
    private static void printPyramidsStarts(int targetNumber) {
        int maximumDigits = 1;
        for (int index = 0; index < targetNumber; index++, maximumDigits += 2) ;
