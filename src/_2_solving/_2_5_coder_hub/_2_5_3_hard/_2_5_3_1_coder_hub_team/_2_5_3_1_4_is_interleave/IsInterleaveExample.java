package _2_solving._2_5_coder_hub._2_5_3_hard._2_5_3_1_coder_hub_team._2_5_3_1_4_is_interleave;
...
public class IsInterleaveExample {
    ...
    private static boolean isInterleave(final String FIRST_TEXT, final String SECOND_TEXT, final String THIRD_TEXT) {
        return Arrays.equals((FIRST_TEXT + SECOND_TEXT).chars().sorted().toArray(), THIRD_TEXT.chars().sorted().toArray());
    }
}