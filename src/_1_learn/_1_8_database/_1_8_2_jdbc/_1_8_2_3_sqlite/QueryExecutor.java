...
class QueryExecutor {
    ...
    void executePrintTable2(final String SQL_QUERY) throws SQLException {
        try (Statement statement = CONNECTION.createStatement();
            ...
            for (int index = 1; index <= columnCount; index++) {
                System.out.printf("%35s", metaData.getColumnName(index));
                if (index < columnCount) System.out.print(" | ");
            ...
            while (resultSet.next()) {
                for (int index = 1; index <= columnCount; index++) {
                    System.out.printf("%35s", resultSet.getString(index));
                    if (index < columnCount) System.out.print(" | ");
                }
                System.out.println();
            }
