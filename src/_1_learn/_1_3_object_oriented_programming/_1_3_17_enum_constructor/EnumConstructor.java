package _1_learn._1_3_object_oriented_programming._1_3_17_enum_constructor;
...
class EnumConstructor {
    public static void main(final String[] ARGUMENTS) {
        ...
        System.out.println("Fruits.APPLE.toString(): " + Fruits.APPLE);
        System.out.println("Fruits.APPLE.getFruit(): " + Fruits.APPLE.getFruit());

        /* Error ! */
        /*
        System.out.print("Fruits.BANANA.getFruit(): " + Fruits.APPLE.getFruit());
        */
    }
}