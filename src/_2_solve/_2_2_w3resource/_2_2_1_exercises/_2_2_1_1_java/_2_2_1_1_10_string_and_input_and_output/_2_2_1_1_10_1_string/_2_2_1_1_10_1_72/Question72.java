...
/**
 * <h1>Problem:</h1>
 * <h2>Write a Java program to return true if a given string contains the string 'qzxpr', and middle 'x' also may contain another character.</h2>
 */

public class Question72 {
    public static void main(final String[] ARGUMENTS) {
        System.out.print(isContainForWordAndMiddleCharacterAlsoMayContainAnotherCharacter("qzxpr"));
    }

    private static boolean isContainForWordAndMiddleCharacterAlsoMayContainAnotherCharacter(final String TEXT) {
        return TEXT.matches(".*qz.pr.*");
    }
}