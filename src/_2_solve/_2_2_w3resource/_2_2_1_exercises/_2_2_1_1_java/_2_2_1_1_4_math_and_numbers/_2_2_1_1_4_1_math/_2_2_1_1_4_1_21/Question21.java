package _2_solve._2_2_w3resource._2_2_1_exercises._2_2_1_1_java._2_2_1_1_4_math_and_numbers._2_2_1_1_4_1_math._2_2_1_1_4_1_21;
...
public class Question21 {
    public static void main(final String[] ARGUMENTS) {
        final int FIRST_NUMBER = 5,
                SECOND_NUMBER = 25;
        System.out.printf("""
                        Input first integer: %d
                        Input first integer: %d
                        Maximum number of distinct prime factors of the said range: %d""",
                FIRST_NUMBER,
                SECOND_NUMBER,
